      ...
      <div class="flex flex-col sm:flex-row items-center justify-between gap-4">
        <div class="w-full">
          <div class="relative w-full sm:max-w-[600px]">
            ...
            <Input
              ...
              class="pl-9 h-10 border-gray-200 rounded-xl bg-white focus-visible:ring-1 focus-visible:ring-indigo-500 text-sm placeholder:text-gray-400"
            />
          </div>
        </div>
        ...
        <DropdownMenu>
          <DropdownMenuTrigger as-child>
            <Button
              variant="outline"
              class="h-10 px-5 border-gray-200 rounded-xl text-gray-700 font-medium whitespace-nowrap shadow-sm hover:bg-gray-50 flex items-center justify-center gap-2 w-full sm:w-auto"
            >
          ...
          <DropdownMenuContent align="end" class="w-40 rounded-xl">
            <DropdownMenuItem @click="statusFilter = 'All Status'">All Status</DropdownMenuItem>
            <DropdownMenuItem @click="statusFilter = 'Active'">Active</DropdownMenuItem>
            <DropdownMenuItem @click="statusFilter = 'Vip'">VIP</DropdownMenuItem>
            <DropdownMenuItem @click="statusFilter = 'Inactive'">Inactive</DropdownMenuItem>
          </DropdownMenuContent>
        </DropdownMenu>
      </div>
    </div>
        ...
        <Table>
          ...
          <TableBody>
            ...
            >
              ...
              <TableCell class="pl-6 align-middle py-4">
                <div class="flex items-center gap-3">
                  ...
                  <div class="flex flex-col justify-center">
                    ...
                    <span class="text-xs text-gray-400 mt-0.5">Joined {{
                      item.joined
                    }}</span>
                  </div>
                </div>
              ...
              <!-- Bookings -->
              <TableCell class="align-middle py-4">
                <span class="font-bold text-sm text-gray-900">{{ item.bookings }}</span>
              </TableCell>
