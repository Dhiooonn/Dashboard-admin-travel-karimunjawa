...
import { Users, UserCheck, Crown } from "lucide-vue-next";
...
<template>
  <div class="grid gap-4 md:grid-cols-3">
    ...
    <Card class="relative overflow-hidden rounded-2xl border-0 bg-[#5C5CFF] shadow-md">
      ...
      <Users class="absolute -right-4 -bottom-4 w-28 h-28 text-white/10 transform -rotate-12 pointer-events-none" />
    ...
    <Card class="relative overflow-hidden rounded-2xl border-0 bg-emerald-500 shadow-md">
      <!-- Decorative Background -->
      <div class="absolute top-0 right-0 w-32 h-32 bg-white/10 rounded-full blur-2xl -mr-8 -mt-8 pointer-events-none"></div>
      <UserCheck class="absolute -right-4 -bottom-4 w-28 h-28 text-white/10 transform rotate-12 pointer-events-none" />
    ...
    <Card class="relative overflow-hidden rounded-2xl border-0 bg-amber-500 shadow-md">
      <!-- Decorative Background -->
      <div class="absolute top-0 right-0 w-32 h-32 bg-white/10 rounded-full blur-2xl -mr-8 -mt-8 pointer-events-none"></div>
      <Crown class="absolute -right-4 -bottom-4 w-28 h-28 text-white/10 transform rotate-[20deg] pointer-events-none" />
      ...
      <CardContent class="relative z-10">
        <div class="text-3xl font-bold text-white">{{ stats.vip }}</div>
      </CardContent>
    </Card>
  </div>
</template>
