...
<template>
  <Card
    class="rounded-[28px] border border-gray-100 shadow-[0_4px_24px_rgb(0,0,0,0.06)] bg-white p-2.5 flex flex-col hover:shadow-[0_8px_30px_rgb(0,0,0,0.12)] transition-shadow"
  >
