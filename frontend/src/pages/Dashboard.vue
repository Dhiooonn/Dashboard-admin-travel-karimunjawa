...
// Icons
import { DollarSign, Calendar, Users, TrendingUp } from "lucide-vue-next";

// Components
import StatCard from "@/components/dashboard/StatCard.vue";
import RevenueOverview from "@/components/dashboard/RevenueOverview.vue";
import QuickActions from "@/components/dashboard/QuickActions.vue";
import BookingStatistics from "@/components/dashboard/BookingStatistics.vue";
...
// Patterns
import patternBg from "@/assets/patterns/welcome-pattern.svg";
...
<template>
  <div class="space-y-6">
    <!-- Welcome section -->
    <section>
      <div class="relative overflow-hidden bg-indigo-500 text-white p-6 rounded-xl flex flex-col gap-1">
        <img 
          :src="patternBg" 
          alt="" 
        ...
        <div class="relative z-10 flex flex-col gap-1">
          ...
          <p class="text-base text-[#E0E7FF]">
            Inilah yang terjadi dengan bisnis perjalanan Anda hari ini.
          </p>
        </div>
      </div>
    </section>
    ...
    <section class="grid grid-cols-1 lg:grid-cols-3 gap-6 items-start">
      <RevenueOverview class="lg:col-span-2" />
      <QuickActions />
    </section>
    ...
    <section class="grid grid-cols-1 lg:grid-cols-3 gap-6 items-start">
      <Bookingcalender class="lg:col-span-2" />
      <RecentActivity />
    </section>
