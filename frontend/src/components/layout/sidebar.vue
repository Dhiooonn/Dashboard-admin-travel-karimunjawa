...
<template>
  <aside
    :class="[
      'fixed top-0 left-0 bg-white border-r border-gray-100 h-screen flex flex-col transition-all duration-300 z-50',
      props.collapsed
  ...
  >
    <!-- header -->
    <div
      class="p-4 border-b border-gray-100 flex items-center justify-between h-[72px]"
    >
