...
<template>
  <div class="space-y-6">
    ...
    <div class="bg-white rounded-2xl p-6">
      <!-- Header -->
      <div
        class="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 pb-6 border-b border-gray-100"
      >
        <div class="space-y-1">
      ...
      >
        ...
        <DropdownMenu>
          ...
          <DropdownMenuContent
            align="end"
            class="w-48 rounded-xl shadow-lg border-gray-100"
          >
            <DropdownMenuItem
              @click="categoryFilter = 'All Categories'"
              class="rounded-lg cursor-pointer my-1"
              >All Categories</DropdownMenuItem
            >
            <DropdownMenuItem
              @click="categoryFilter = 'Resort'"
              class="rounded-lg cursor-pointer my-1"
              >Resort</DropdownMenuItem
            >
            <DropdownMenuItem
              @click="categoryFilter = 'Activity'"
              class="rounded-lg cursor-pointer my-1"
              >Activity</DropdownMenuItem
            >
            <DropdownMenuItem
              @click="categoryFilter = 'Tour'"
              class="rounded-lg cursor-pointer my-1"
